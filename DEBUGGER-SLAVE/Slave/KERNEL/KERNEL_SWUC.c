 ...
 * @LastEditTime: 2023-04-04 11:08:20
 * @Description: 
 * 
 * 
...
void SWUC_KBRST_Init(uint8_t mode)
{
	...
	if(mode==1)
	{
		*((volatile uint8_t *)(0x2456)) &= 0xfe;   //set KBCHIKDOR bit0 0
...
{
	SWUC_G20_Config();  //set GPB5 GA20

	if(mode==1)
	{
		*((volatile uint8_t *)(0x2456)) &= 0xfd;   //set KBCHIKDOR bit1 0
		for(BYTE  i=0;i<20;i++)
		{
